...
export default function ConciliacaoBalancetes() {
  ...
  return (
    <div className="w-full max-w-full px-2 sm:px-4 py-6 space-y-4 animate-fade-in-up">
      ...
      {/* Horizontal scroll wrapper to align the summary cards perfectly with the table columns */}
        ...
        <div className="min-w-[1200px] flex flex-col space-y-4">
          <div className="flex w-full justify-between items-stretch">
            <div
              ...
              className={cn(
                'w-[28%] bg-gradient-to-br from-[#0d5d5d] to-[#1dd1a1] rounded-[16px] border-0 cursor-pointer transition-all duration-200 hover:scale-[1.02] text-white shadow-md hover:shadow-xl hover:shadow-[#1dd1a1]/20 p-3 sm:p-4 flex flex-col justify-between min-h-[85px] relative',
                natureFilter === 'ATIVO'
                  ? 'ring-4 ring-[#1dd1a1] ring-offset-2 dark:ring-offset-slate-900 z-10'
                  : '',
              )}
            >
              <div className="text-[11px] sm:text-xs font-bold opacity-95 tracking-wide uppercase">
                CONTAS DE ATIVO
              </div>
              <div>
            ...
            <div
              ...
              className={cn(
                'w-[20%] bg-gradient-to-br from-[#6c0572] to-[#ff006e] rounded-[16px] border-0 cursor-pointer transition-all duration-200 hover:scale-[1.02] text-white shadow-md hover:shadow-xl hover:shadow-[#ff006e]/20 p-3 sm:p-4 flex flex-col justify-between min-h-[85px] relative',
                natureFilter === 'PASSIVO'
                  ? 'ring-4 ring-[#ff006e] ring-offset-2 dark:ring-offset-slate-900 z-10'
                  : '',
              )}
            >
              <div className="text-[11px] sm:text-xs font-bold opacity-95 tracking-wide uppercase">
            ...
            <div
              ...
              className={cn(
                'w-[20%] bg-gradient-to-br from-[#003d82] to-[#0099ff] rounded-[16px] border-0 cursor-pointer transition-all duration-200 hover:scale-[1.02] text-white shadow-md hover:shadow-xl hover:shadow-[#0099ff]/20 p-3 sm:p-4 flex flex-col justify-between min-h-[85px] relative',
                natureFilter === 'RECEITAS'
                  ? 'ring-4 ring-[#0099ff] ring-offset-2 dark:ring-offset-slate-900 z-10'
                  : '',
              )}
            >
              <div className="text-[11px] sm:text-xs font-bold opacity-95 tracking-wide uppercase">
            ...
            <div
              ...
              className={cn(
                'w-[29%] bg-gradient-to-br from-[#8b4513] to-[#ff8c00] rounded-[16px] border-0 cursor-pointer transition-all duration-200 hover:scale-[1.02] text-white shadow-md hover:shadow-xl hover:shadow-[#ff8c00]/20 p-3 sm:p-4 flex flex-col justify-between min-h-[85px] relative',
                natureFilter === 'DESPESAS'
                  ? 'ring-4 ring-[#ff8c00] ring-offset-2 dark:ring-offset-slate-900 z-10'
                  : '',
              )}
            >
              <div className="text-[11px] sm:text-xs font-bold opacity-95 tracking-wide uppercase">
          ...
          <Card className="border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden bg-card">
            ...
            <CardContent className="p-0 bg-transparent">
              <Table
                wrapperClassName="max-h-[calc(100vh-320px)] overflow-y-auto overflow-x-hidden"
                className="w-full table-fixed text-[10px] leading-tight border-separate border-spacing-0 [&_tr]:border-none"
              >
                <TableHeader className="sticky top-0 z-30">
                  <TableRow className="bg-transparent hover:bg-transparent border-none">
                    <TableHead
                      style={{ width: '28%' }}
                      colSpan={3}
                      className="h-6 py-0 px-2 text-center align-middle font-bold text-black bg-gradient-to-br from-[#0d5d5d] to-[#1dd1a1] rounded-t-lg border-none text-[11px]"
                    >
                      Identificação da Conta
                    </TableHead>
                    <TableHead
                      style={{ width: '1%' }}
                      className="p-0 border-none shadow-none bg-white dark:bg-slate-950"
                    />
                    <TableHead
                      style={{ width: '20%' }}
                      colSpan={4}
                      className="h-6 py-0 px-2 text-center align-middle font-bold text-black bg-gradient-to-br from-[#6c0572] to-[#ff006e] rounded-t-lg border-none text-[11px]"
                    >
                      VELIT
                    </TableHead>
                    <TableHead
                    ...
                    <TableHead
                      style={{ width: '20%' }}
                      colSpan={4}
                      className="h-6 py-0 px-2 text-center align-middle font-bold text-black bg-gradient-to-br from-[#003d82] to-[#0099ff] rounded-t-lg border-none text-[11px]"
                    >
                      DOMÍNIO
                    </TableHead>
                    <TableHead
                    ...
                    <TableHead
                      style={{ width: '29%' }}
                      colSpan={5}
                      className="h-6 py-0 px-2 text-center align-middle font-bold text-black bg-gradient-to-br from-[#8b4513] to-[#ff8c00] rounded-t-lg border-none text-[11px]"
                    >
                  ...
                  <TableRow className="bg-transparent hover:bg-transparent border-none">
                    ...
                    <TableHead
                      style={{ width: '5%' }}
                      className="h-6 py-0 px-1 font-bold text-black bg-gradient-to-br from-[#6c0572] to-[#ff006e] border-none border-t border-t-black/10 text-center align-middle text-[10px]"
                    >
                      Saldo Ant.
                    </TableHead>
                    <TableHead
                    ...
                    <TableHead
                      style={{ width: '5%' }}
                      className="h-6 py-0 px-1 font-bold text-black bg-gradient-to-br from-[#003d82] to-[#0099ff] border-none border-t border-t-black/10 text-center align-middle text-[10px]"
                    >
                      Saldo Ant.
                    </TableHead>
                    <TableHead
                    ...
                    <TableHead
                      style={{ width: '5%' }}
                      className="h-6 py-0 px-0.5 font-bold text-black bg-gradient-to-br from-[#8b4513] to-[#ff8c00] border-none border-t border-t-black/10 text-center align-middle text-[10px]"
                    >
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              ...
                              size="icon"
                              className={cn(
                                'h-4 w-4 p-0 hover:bg-black/10 dark:hover:bg-black/20 text-black',
                    ...
                    <TableHead
                      style={{ width: '9%' }}
                      className="h-6 py-0 px-2 font-bold text-black bg-gradient-to-br from-[#8b4513] to-[#ff8c00] border-none border-t border-t-black/10 text-center align-middle text-[10px]"
                    >
                      Status
                    </TableHead>
                  </TableRow>
                    ...
                    paginatedData.map((row) => {
                      ...
                      return (
                        ...
                        >
                          <TableCell
                            className={cn(
                              'py-1 px-2 h-auto font-medium whitespace-nowrap transition-all duration-100 border-l border-l-transparent text-center',
                              baseBg,
                            )}
                          >
                            {row.codigo}
                          ...
                          <TableCell className="spacer p-0 bg-transparent border-none transition-all duration-100" />

                          <TableCell
                            className={cn(
                              'py-1 px-1 sm:px-2 h-auto text-right whitespace-nowrap opacity-90 border-l border-slate-200/20 transition-all duration-100',
                              baseBg,
                            )}
                          >
                          ...
                          <TableCell
                            className={cn(
                              'py-1 px-1 sm:px-2 h-auto text-right whitespace-nowrap opacity-90 transition-all duration-100',
                              baseBg,
                            )}
                          >
                          ...
                          <TableCell
                            className={cn(
                              'py-1 px-1 sm:px-2 h-auto text-right font-medium whitespace-nowrap border-r border-slate-200/20 transition-all duration-100',
                              baseBg,
                            )}
                          >
                          ...
                          <TableCell
                            className={getDiffCellClass(
                              ...
                              row.classificacao,
                              'py-1 px-1 sm:px-2 h-auto text-right whitespace-nowrap border-l border-slate-200/20 transition-all duration-100',
                            )}
                          >
                          ...
                          <TableCell
                            className={getDiffCellClass(
                              row.dif_debito,
                              row.classificacao,
                              'py-1 px-1 sm:px-2 h-auto text-right whitespace-nowrap transition-all duration-100',
                            )}
                          >
                          ...
                          <TableCell
                            className={cn(
                              'py-1 px-1 sm:px-2 h-auto text-center whitespace-nowrap border-r border-r-transparent transition-all duration-100',
                              baseBg,
                            )}
                          >
                ...
                {paginatedData.length > 0 && (
                  <TableFooter className="sticky bottom-0 z-30 bg-transparent border-none">
                    <TableRow className="border-none hover:bg-transparent bg-transparent shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                      ...
                      <TableCell className="spacer p-0 border-none shadow-none bg-white dark:bg-slate-950" />

                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-indigo-800 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/50 rounded-bl-xl border-b border-l border-indigo-300 dark:border-indigo-800/50">
                        {formatCurrency(totaisDinamicos.saldo_anterior_velit)}
                      </TableCell>
                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-indigo-800 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/50 border-b border-indigo-300 dark:border-indigo-800/50">
                        {formatCurrency(totaisDinamicos.debito_velit)}
                      </TableCell>
                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-indigo-800 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/50 border-b border-indigo-300 dark:border-indigo-800/50">
                        {formatCurrency(totaisDinamicos.credito_velit)}
                      </TableCell>
                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-indigo-900 dark:text-indigo-200 bg-indigo-100 dark:bg-indigo-900/50 rounded-br-xl border-b border-r border-indigo-300 dark:border-indigo-800/50">
                        {formatCurrency(totaisDinamicos.saldo_atual_velit)}
                      </TableCell>

                      <TableCell className="spacer p-0 border-none shadow-none bg-white dark:bg-slate-950" />

                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-900/50 rounded-bl-xl border-b border-l border-emerald-300 dark:border-emerald-800/50">
                        {formatCurrency(totaisDinamicos.saldo_anterior_dominio)}
                      </TableCell>
                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-900/50 border-b border-emerald-300 dark:border-emerald-800/50">
                        {formatCurrency(totaisDinamicos.debito_dominio)}
                      </TableCell>
                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-900/50 border-b border-emerald-300 dark:border-emerald-800/50">
                        {formatCurrency(totaisDinamicos.credito_dominio)}
                      </TableCell>
                      <TableCell className="text-right py-3 px-1 sm:px-2 font-bold text-emerald-900 dark:text-emerald-200 bg-emerald-100 dark:bg-emerald-900/50 rounded-br-xl border-b border-r border-emerald-300 dark:border-emerald-800/50">
                      ...
                      <TableCell
                        className={cn(
                          'text-right py-3 px-1 sm:px-2 font-bold rounded-bl-xl border-b border-l border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800/80',
                      ...
                      <TableCell
                        className={cn(
                          'text-right py-3 px-1 sm:px-2 font-bold border-b border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800/80',
